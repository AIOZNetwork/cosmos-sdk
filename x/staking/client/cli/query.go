...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			addr, err := sdk.ValAddressFromString(args[0])
			if err != nil {
				return err
			}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			delAddr, err := sdk.AccAddressFromString(args[0])
			if err != nil {
				return err
			}

			valAddr, err := sdk.ValAddressFromString(args[1])
			if err != nil {
				return err
			}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			delegatorAddr, err := sdk.AccAddressFromString(args[0])
			if err != nil {
				return err
			}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			valSrcAddr, err := sdk.ValAddressFromString(args[1])
			if err != nil {
				return err
			}

			valDstAddr, err := sdk.ValAddressFromString(args[2])
			if err != nil {
				return err
			}
